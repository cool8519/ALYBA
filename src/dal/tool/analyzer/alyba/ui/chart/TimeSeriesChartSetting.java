...
public class TimeSeriesChartSetting extends ChartSetting {
	...
	protected void createContents() {
		...
		chk_sma.setLayoutData(new FormData());
		chk_sma.setText(" Simple Moving Average");
		chk_sma.setBounds(20, 20, 170, 16);
		...
		fd_chk_merge.top = new FormAttachment(lb_sma_avg, 30);
		...
		fd_chk_shape.top = new FormAttachment(lb_merge_every, 30);
