...
public class LogAnalyzerSetting {
	...
	public LogFieldMappingInfo fieldMapping;
	...
	public LogFieldMappingInfo getFieldMapping() {
		return fieldMapping;
	}

	public void setFieldMapping(LogFieldMappingInfo fieldMapping) {
