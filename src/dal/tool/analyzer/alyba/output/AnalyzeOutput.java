...
public class AnalyzeOutput {
	...
	private SettingEntryVO getSettingEntryVO(AnalyzerSetting setting) {
		...
		vo.mappingFieldCount = setting.getFieldMapping().getLogFieldCount();
		vo.mappingInfo = setting.getFieldMapping().getMappingInfo();
